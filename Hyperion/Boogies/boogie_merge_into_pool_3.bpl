...
L23:
    ...
    // assert Not(Eq<u128>($t3, 0)) at /Users/jackfisher/Desktop/audits/dex-v3-latest/sources/v3/pool_v3.move:1758:5+31
    assume {:print "$at(19,68183,68214)"} true;
    assert {:msg "assert_failed(19,68183,68214): function does not abort under this condition"}
      !$IsEqual'u128'($t3, 0);

    // return ($t3, $t6, $t7, $t27, $t28) at /Users/jackfisher/Desktop/audits/dex-v3-latest/sources/v3/pool_v3.move:1758:5+31
    $ret0 := $t3;
    $ret1 := $t6;
    $ret2 := $t7;
    $ret3 := $t27;
