...
// spec fun at /Users/jackfisher/.move/https___github_com_aptos-labs_aptos-framework_git_mainnet/aptos-framework/../aptos-stdlib/../move-stdlib/sources/vector.move:199:5+92
function {:inline} $1_vector_$is_empty'$1_fungible_asset_FungibleAsset'(self: Vec ($1_fungible_asset_FungibleAsset)): bool {
    $IsEqual'u64'($1_vector_$length'$1_fungible_asset_FungibleAsset'(self), 0)
}
...
// spec fun at /Users/jackfisher/.move/https___github_com_aptos-labs_aptos-framework_git_mainnet/aptos-framework/../aptos-stdlib/../move-stdlib/sources/option.move:61:5+101
function {:inline} $1_option_$is_none'$1_fungible_asset_FungibleAsset'(self: $1_option_Option'$1_fungible_asset_FungibleAsset'): bool {
    $1_vector_$is_empty'$1_fungible_asset_FungibleAsset'(self->$vec)
}
...
procedure {:timeLimit 40} $aa_pool_v3_dividen_from_pool$verify(_$t0: $Mutation ($aa_pool_v3_LiquidityPoolV3), _$t1: $aa_i32_I32, _$t2: $aa_i32_I32, _$t3: int) returns ($ret0: int, $ret1: int, $ret2: int, $ret3: $1_option_Option'$1_fungible_asset_FungibleAsset', $ret4: $1_option_Option'$1_fungible_asset_FungibleAsset', $ret5: $Mutation ($aa_pool_v3_LiquidityPoolV3))
{
    ...
    // $t8 := read_ref($t0) at /Users/jackfisher/Desktop/audits/dex-v3-latest/sources/v3/pool_v3.move:1764:5+1
    $t8 := $Dereference($t0);
...
L7:
    ...
    // assert Implies(Eq<u128>($t3, 0), And(And(And(And(And(Eq<u128>($t3, 0), Eq<u64>($t6, 0)), Eq<u64>($t7, 0)), option::$is_none<0x1::fungible_asset::FungibleAsset>($t9)), option::$is_none<0x1::fungible_asset::FungibleAsset>($t10)), Eq<u128>(select pool_v3::LiquidityPoolV3.liquidity<0xaa::pool_v3::LiquidityPoolV3>($t0), select pool_v3::LiquidityPoolV3.liquidity<0xaa::pool_v3::LiquidityPoolV3>($t8)))) at /Users/jackfisher/Desktop/audits/dex-v3-latest/sources/v3/pool_v3.move:1844:5+234
    assume {:print "$at(19,72238,72472)"} true;
    assert {:msg "assert_failed(19,72238,72472): post-condition does not hold"}
      ($IsEqual'u128'($t3, 0) ==> ((((($IsEqual'u128'($t3, 0) && $IsEqual'u64'($t6, 0)) && $IsEqual'u64'($t7, 0)) && $1_option_$is_none'$1_fungible_asset_FungibleAsset'($t9)) && $1_option_$is_none'$1_fungible_asset_FungibleAsset'($t10)) && $IsEqual'u128'($Dereference($t0)->$liquidity, $t8->$liquidity)));

    // return ($t3, $t6, $t7, $t9, $t10) at /Users/jackfisher/Desktop/audits/dex-v3-latest/sources/v3/pool_v3.move:1844:5+234
    $ret0 := $t3;
    $ret1 := $t6;
    $ret2 := $t7;
    $ret3 := $t9;
